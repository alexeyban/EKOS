# ekos_semantic::transform_ir::TransformOrigin (RustModule)
...
```mermaid
graph TD
    na3e58c8365475734aab4a9ce51b8289d["ekos_semantic::transform_ir::TransformOrigin"]
    n196ca3fde85c5ab9a14250f63dc586b9["ekos/crates/recovery/src/python_analyzer.rs"]
    n196ca3fde85c5ab9a14250f63dc586b9 -->|DependsOn| na3e58c8365475734aab4a9ce51b8289d
    nce3d2f1be1c655d792bcc1b69f76dbca["ekos/crates/recovery/src/pentaho_analyzer.rs"]
    nce3d2f1be1c655d792bcc1b69f76dbca -->|DependsOn| na3e58c8365475734aab4a9ce51b8289d
    n987e3fbb31ec576db7947e801336e8c8["ekos/crates/recovery/src/sql_transform_analyzer.rs"]
    n987e3fbb31ec576db7947e801336e8c8 -->|DependsOn| na3e58c8365475734aab4a9ce51b8289d
```
