# ekos_semantic::merge_graphs (RustModule)
...
```mermaid
graph TD
    n06ac43b263cd5be78da1202683809b64["ekos_semantic::merge_graphs"]
    n196ca3fde85c5ab9a14250f63dc586b9["ekos/crates/recovery/src/python_analyzer.rs"]
    n196ca3fde85c5ab9a14250f63dc586b9 -->|DependsOn| n06ac43b263cd5be78da1202683809b64
    nce3d2f1be1c655d792bcc1b69f76dbca["ekos/crates/recovery/src/pentaho_analyzer.rs"]
    nce3d2f1be1c655d792bcc1b69f76dbca -->|DependsOn| n06ac43b263cd5be78da1202683809b64
    n987e3fbb31ec576db7947e801336e8c8["ekos/crates/recovery/src/sql_transform_analyzer.rs"]
    n987e3fbb31ec576db7947e801336e8c8 -->|DependsOn| n06ac43b263cd5be78da1202683809b64
```
