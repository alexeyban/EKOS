...
| Founder — Personal Wallet | 3,240,000 | 0.32% | Personal wallet, left for flexibility |
| Community Rewards | 5,000,000 | 0.5% | Separate Metamask wallet |
| Treasury | 2,000,000 | 0.2% | Separate Phantom wallet |
| Public / Circulating | ~971,000,000 | ~97.1% | Pump.fun bonding curve / open market |

Founder total: 28,240,000 EKOS (1.4% vesting + 0.32% personal wallet + 0.5% Community Rewards + 0.4% Founder Lock + 0.2% Treasury  = 2.8% of supply).
