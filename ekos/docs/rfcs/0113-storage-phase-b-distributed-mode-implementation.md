...
the v1 scope; remaining items are the tracked v1 → v1.1 follow-ons in Open Questions (connection
pool, parallel fan-out, coordinator-index pruning, Local→Distributed partition registration) plus
lease→real-`build`/`commit` binding.
**Author:** EKOS team
**Created:** 2026-08-29
